...
# M V C
MODEL = $(SERVERAVIONENEMIGO) $(SERVERAVIONENEMIGORANDOM) $(RESOLUCION) $(POSICION) $(VIVIBLE) $(COMPOSITE) $(AVION) $(MISIL) $(MISILDIRIGIDO) $(PLAYER) $(POWERUP) $(SOUND) $(MUSIC) $(ENEMY)
VIEW = $(AVION_VIEW) $(ENEMY_VIEW) $(TEXTURE) $(BACKGROUND) $(ISLA) $(MISIL_VIEW) $(SCREEN) $(HEALTH_VIEW) $(SCORE_VIEW) $(POWERUP_VIEW) $(EXPLOSION_VIEW)
CONTROLLER = $(CONTROLLER_CONTROLLER) $(PLAYERS_CONTROLLERS) $(MISILES_CONTROLLERS) $(MISILES_CONTROLLERS_ENEMY) $(TIMER_CONTROLLER) $(HANDLER_CONTROLLER) $(HANDLER_POWERUP)
# RED
# client
