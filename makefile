...
# M V C
MODEL = $(SERVERAVIONENEMIGO) $(SERVERAVIONENEMIGORANDOM) $(SERVERAVIONENEMIGOGRANDE) $(RESOLUCION) $(POSICION) $(VIVIBLE) $(COMPOSITE) $(AVION) $(MISIL) $(MISILDIRIGIDO) $(PLAYER) $(POWERUP) $(SOUND) $(MUSIC) $(ENEMY) $(ENEMYMEDIANO) $(ENEMYGRANDE)
